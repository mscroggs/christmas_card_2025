...
\item For every pair of digits that appears in each answer, colour the two squares on the front
    cover that contain the pair. For example, if an answer in the green section were
...
\begin{enumerlist}
\item[9.] What is the smallest two-digit positive integer that cannot be written as the sum of consecutive integers?
...
\end{center}
\vfill
\begin{center}\input{footer.tex}\end{center}
\vspace{1mm}
\end{minipage}
